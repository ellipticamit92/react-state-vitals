import {
  detectZustand
} from "./chunk-HELXSMSG.mjs";
import {
  detectReactQuery
} from "./chunk-BPCINUOV.mjs";
import {
  clearRegistry,
  getRegistry,
  registerStore,
...
function SparklineChart({
  ...
  if (!hasData) {
    return /* @__PURE__ */ jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsx("span", { className: "text-[9px] text-slate-600", children: "collecting\u2026" })
      }
    );
  }
  const pad = 4;
  const renderedSeries = series.filter((s) => s.data.length >= 2).map((s) => {
    ...
    return __spreadProps(__spreadValues({}, s), { pts });
  });
  return /* @__PURE__ */ jsxs(
    "svg",
    {
      ...
      children: [
        /* @__PURE__ */ jsx("defs", { children: renderedSeries.map((s) => /* @__PURE__ */ jsxs("linearGradient", { id: s.gradientId, x1: "0", y1: "0", x2: "0", y2: "1", children: [
          /* @__PURE__ */ jsx("stop", { offset: "0%", stopColor: s.gradientColor, stopOpacity: "0.3" }),
          /* @__PURE__ */ jsx("stop", { offset: "100%", stopColor: s.gradientColor, stopOpacity: "0.0" })
        ] }, s.gradientId)) }),
        renderedSeries.map((s) => {
          ...
          return /* @__PURE__ */ jsxs("g", { children: [
            /* @__PURE__ */ jsx("polygon", { points: fillPoly, fill: `url(#${s.gradientId})` }),
            /* @__PURE__ */ jsx(
              "polyline",
              {
                points: polyline,
            ...
            /* @__PURE__ */ jsx("circle", { cx: last[0], cy: last[1], r: "2.5", fill: s.strokeColor })
          ] }, s.gradientId);
        })
      ]
    }
...
function CircularGauge({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center gap-1", children: [
    ...
    /* @__PURE__ */ jsx("span", { className: "text-[9px] text-slate-400 text-center leading-tight", children: label })
  ] });
}
function Dot({
  level,
...
function ProgressBar({
  ...
  return /* @__PURE__ */ jsx("div", { className: "h-1 w-full bg-gray-700 rounded overflow-hidden", children: /* @__PURE__ */ jsx(
    "div",
    {
...
function Row({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "px-2 py-1 rounded hover:bg-gray-800 transition-colors", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between text-[10px]", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex min-w-0 flex-1 items-center gap-1.5 truncate", children: [
        /* @__PURE__ */ jsx(Dot, { level, colorOverride: dotColor }),
        /* @__PURE__ */ jsx("span", { className: `truncate ${nameColor}`, children: name })
      ] }),
      /* @__PURE__ */ jsxs(
        "span",
        {
          ...
          children: [
            formatKB(sizeKB),
            limitKB > 0 && /* @__PURE__ */ jsxs("span", { className: "text-slate-500", children: [
              "/",
              formatKB(limitKB)
            ] })
          ]
    ...
    extra ? /* @__PURE__ */ jsx("div", { className: "mt-1 flex flex-wrap items-center justify-end gap-2 text-[9px]", children: extra }) : null,
...
function Section({
  ...
  return /* @__PURE__ */ jsx(
    Collapsible,
    {
      open,
      onToggle,
      title: /* @__PURE__ */ jsxs("span", { className: "text-[11px] text-slate-300 font-semibold uppercase tracking-wide", children: [
        title,
        " ",
      ...
      children: /* @__PURE__ */ jsx("div", { className: "space-y-0.5 pb-1", children: items.map(render) })
    }
  );
}
function StoreRow({ store, accent = "green" }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "px-2 py-1 rounded hover:bg-gray-800 transition-colors", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between text-[10px]", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex min-w-0 flex-1 items-center gap-1.5 truncate", children: [
        /* @__PURE__ */ jsx(Dot, { level, colorOverride: dotColor }),
        /* @__PURE__ */ jsx("span", { className: `truncate ${nameColor}`, children: store.name })
      ] }),
      /* @__PURE__ */ jsxs("span", { className: `tabular-nums pl-2 ${level === "ok" ? nameColor : text}`, children: [
        formatKB(store.sizeKB),
        store.limitKB > 0 && /* @__PURE__ */ jsxs("span", { className: "text-slate-500", children: [
          "/",
          formatKB(store.limitKB)
        ] })
      ] })
    ] }),
    store.renders ? /* @__PURE__ */ jsx("div", { className: "mt-1 flex flex-wrap items-center justify-end gap-2 text-[9px]", children: /* @__PURE__ */ jsxs("span", { className: "text-cyan-400", children: [
      store.renders,
      " ",
    ...
    consumers.length > 0 && /* @__PURE__ */ jsx("div", { className: "mt-1.5 space-y-0.5", children: consumers.map((consumer) => /* @__PURE__ */ jsxs(
      "div",
      {
        className: "flex items-center justify-between text-[9px] px-1",
        children: [
          /* @__PURE__ */ jsxs("span", { className: "text-slate-400 truncate", children: [
            "\u2013 ",
            consumer.component
          ] }),
          /* @__PURE__ */ jsxs("span", { className: "tabular-nums text-cyan-500 pl-2 shrink-0", children: [
            consumer.renders,
            "\xD7"
          ] })
        ]
...
function ContextRow({ store }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "px-2 py-1 rounded hover:bg-gray-800 transition-colors", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between text-[10px]", children: [
      ...
      /* @__PURE__ */ jsxs("span", { className: `tabular-nums pl-2 ${nameColor}`, children: [
        formatKB(store.sizeKB),
        store.renders ? /* @__PURE__ */ jsxs("span", { className: "text-slate-500 ml-1", children: [
          store.renders,
          " ",
          store.renders === 1 ? "render" : "renders"
        ] }) : null
    ...
    store.consumerRenders ? /* @__PURE__ */ jsxs("div", { className: "mt-0.5 text-[9px] text-violet-400", children: [
  ...
  return /* @__PURE__ */ jsx(
    Row,
    {
      ...
      extra: /* @__PURE__ */ jsxs(Fragment, { children: [
        fetching > 0 && /* @__PURE__ */ jsxs("span", { className: "text-blue-400", children: [
          fetching,
          " fetching"
        ] }),
        errors > 0 && /* @__PURE__ */ jsxs("span", { className: "text-red-400", children: [
          errors,
          " err"
        ] }),
    ...
    const unsubStore = emitter.on(
      ...
      ({
        ...
        setStores((prev) => {
          ...
          const type = (_c2 = (_b2 = existing == null ? void 0 : existing.type) != null ? _b2 : (_a2 = getRegistry().get(name)) == null ? void 0 : _a2.type) != null ? _c2 : "zustand";
          const next = [
  ...
  if (!isOpen) {
    return /* @__PURE__ */ jsxs(
      "button",
      {
        ...
        children: [
          /* @__PURE__ */ jsx(Dot, { level: "ok", className: "w-2 h-2" }),
          "StateVitals"
        ]
      }
    );
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
          ...
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsx("svg", { width: "14", height: "12", viewBox: "0 0 14 12", fill: "none", children: [0, 4, 8].map((y) => /* @__PURE__ */ jsx(
                  "line",
                  {
                    x1: "0",
                    y1: y + 1,
                ...
                /* @__PURE__ */ jsx("span", { className: "text-[13px] font-semibold text-slate-100", children: "StateVitals Monitor" })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1", onMouseDown: (e) => e.stopPropagation(), children: [
                /* @__PURE__ */ jsx(
                  "button",
                  {
        ...
        conflicts.length > 0 && /* @__PURE__ */ jsx("div", { className: "border-b border-yellow-500/30 bg-yellow-500/10 px-2.5 py-1.5 space-y-1 shrink-0", children: conflicts.map((c) => /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-1.5", children: [
          /* @__PURE__ */ jsx("span", { className: "text-yellow-400 mt-px flex-shrink-0", children: "\u26A0" }),
          /* @__PURE__ */ jsx("span", { className: "text-yellow-300 text-[8px] leading-snug", children: c.message }),
          /* @__PURE__ */ jsx(
            "button",
            {
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex-1 min-h-0 overflow-y-auto", children: [
          (heap || statesHistory.length > 0) && /* @__PURE__ */ jsx(
            Collapsible,
            {
              open: memoryOpen,
              onToggle: () => setMemoryOpen((v) => !v),
              title: /* @__PURE__ */ jsx("span", { className: "text-[11px] text-slate-300 font-semibold uppercase tracking-wide", children: "Memory" }),
              children: /* @__PURE__ */ jsxs("div", { className: "px-2 pb-2", children: [
                /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 mb-2 text-[10px]", children: [
                  heap && /* @__PURE__ */ jsxs(Fragment, { children: [
                    ...
                    /* @__PURE__ */ jsxs("span", { className: "flex items-center gap-1 text-slate-400", children: [
                      /* @__PURE__ */ jsx("span", { className: "inline-block w-2 h-0.5 rounded", style: { background: "#22d3ee" } }),
                      "Heap:",
                      " ",
                  ...
                  statesHistory.length > 0 && /* @__PURE__ */ jsxs("span", { className: "flex items-center gap-1 text-slate-400", children: [
                    /* @__PURE__ */ jsx("span", { className: "inline-block w-2 h-0.5 rounded", style: { background: "#34d399" } }),
                    "States:",
                    " ",
                    /* @__PURE__ */ jsx("span", { className: "text-emerald-400 font-semibold", children: formatKB((_c = statesHistory[statesHistory.length - 1]) != null ? _c : 0) })
                  ] })
                ] }),
                /* @__PURE__ */ jsxs(
                  "div",
                  {
                    ...
                    children: [
                      ...
                      heap && /* @__PURE__ */ jsx(CircularGauge, { pct: heapPct, label: "Heap Usage", size: 72 })
                    ]
                  }
                )
              ] })
          ...
          (heap || statesHistory.length > 0) && stores.length > 0 && /* @__PURE__ */ jsx("div", { className: "border-t border-slate-800 mx-2" }),
          stores.length > 0 && /* @__PURE__ */ jsx(
            Collapsible,
            {
              open: statesOpen,
              onToggle: () => setStatesOpen((v) => !v),
              title: /* @__PURE__ */ jsx("span", { className: "text-[11px] text-slate-300 font-semibold uppercase tracking-wide", children: "Active States" }),
              children: /* @__PURE__ */ jsxs("div", { className: "space-y-2 pb-2", children: [
                zustand.length > 0 && /* @__PURE__ */ jsx(
                  Section,
                  {
                    title: "Zustand",
                    items: zustand,
                    render: (s) => /* @__PURE__ */ jsx(StoreRow, { store: s, accent: "green" }, s.name),
                    open: zustandOpen,
                    onToggle: () => setZustandOpen((v) => !v)
                  }
                ),
                context.length > 0 && /* @__PURE__ */ jsx(
                  Section,
                  {
                    title: "React Context",
                    items: context,
                    render: (s) => /* @__PURE__ */ jsx(ContextRow, { store: s }, s.name),
                    open: contextOpen,
                    onToggle: () => setContextOpen((v) => !v)
                  }
                ),
                cache.length > 0 && /* @__PURE__ */ jsx(
                  Section,
                  {
                    title: "Cache",
                    items: cache,
                    render: (s) => /* @__PURE__ */ jsx(CacheRow, { store: s }, s.name),
                    open: cacheOpen,
        ...
        (stores.length > 0 || heap) && /* @__PURE__ */ jsx("div", { className: "px-3 py-1.5 border-t border-slate-700 bg-slate-800/60 shrink-0", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between text-[10px]", children: [
          /* @__PURE__ */ jsx("span", { className: "text-slate-400", children: "Total Size" }),
          /* @__PURE__ */ jsx(
            "span",
            {
        ...
        /* @__PURE__ */ jsx(
          "button",
          {
            ...
            children: /* @__PURE__ */ jsx("span", { className: "absolute bottom-1 right-1 h-2 w-2 border-r border-b border-slate-500" })
          }
        )
      ]
    }
...
function useContextMonitor(name, value, options = {}) {
  ...
  const getterRef = useRef2(getValue);
  const snapshotsRef = useRef2([]);
  const renderCountRef = useRef2(0);
  valueRef.current = value;
  getterRef.current = getValue;
  renderCountRef.current += 1;
  const stableGetter = useRef2(
...
function monitorContext(name, context, options = {}) {
  ...
  function monitor({ children }) {
    ...
    return createElement2(Fragment2, null, children);
  }
...
function patchContext(name, context, options = {}) {
  ...
  function MonitoredProvider({
    ...
    useContextMonitor(name, value, options);
    return createElement2(OriginalProvider, { value }, children);
  }
...
function createMonitoredContext(name, limitKB = DEFAULT_LIMIT_KB) {
  ...
  function Provider({ value, children }) {
    ...
    return createElement2(Context.Provider, { value }, children);
  }
